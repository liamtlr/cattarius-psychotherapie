declare global {
  const __buildAssetsURL: typeof import('/usr/app/node_modules/nuxt/dist/core/runtime/nitro/paths')['buildAssetsURL']
  const __publicAssetsURL: typeof import('/usr/app/node_modules/nuxt/dist/core/runtime/nitro/paths')['publicAssetsURL']
  ...
  const cachedEventHandler: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineAppConfig: typeof import('/usr/app/node_modules/nuxt/dist/core/runtime/nitro/config')['defineAppConfig']
  const defineCachedEventHandler: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useAppConfig: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['useAppConfig']
  const useBase: typeof import('h3')['useBase']
  const useNitroApp: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('/usr/app/node_modules/nitropack/dist/runtime')['useStorage']
