globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///usr/app/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///usr/app/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///usr/app/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///usr/app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///usr/app/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///usr/app/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///usr/app/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///usr/app/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///usr/app/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///usr/app/node_modules/hookable/dist/index.mjs';
...
import { hash } from 'file:///usr/app/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///usr/app/node_modules/ufo/dist/index.mjs';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/usr/app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/usr/app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/usr/app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/usr/app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_Z8u2jf = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Z8u2jf, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Z8u2jf, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/usr/app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/usr/app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
